		...
		<table class="table table-bordered">
			<thead>
				<tr>
					...
					<th>Username</th>
					<th>Password</th>
					<th style="row-width: 200%">Qualification</th>
					<th>Mobile</th>
					<th>Gender</th>
					<th>Created Date</th>
					<th>Photo</th>
			...
			<tbody>
				...
				<c:forEach items="${data}" var="ans" varStatus="sno">
					<tr>
						...
						<td><img src="data:image/jpeg;base64, ${ans.photo }"
							height=100px class=zoom></td>

						<td><a href="${pageContext.request.contextPath}/editData?email=${ans.email }"><img
								src="Image/edit.png" height=30px></a> &nbsp;&nbsp;&nbsp; <a
							href="${pageContext.request.contextPath}/delete?email=${ans.email }"><img src="Image/delete.png"
								height=30px></a></td>
					</tr>
				</c:forEach>
