...
<body>
	<form action="signup" method="post">
		...
		<marquee direction="right">Sign Up</marquee>
			...
			<h3>
				Photo<br> <input name="photo" type="file" style="width: 500px">
			</h3>
<h3>
...
<a href="${pageContext.request.contextPath}/login.jsp"><button type="button" class="btn btn-success">Login</button></a>
		</div>
	</form>
</body>
</html>